...
export * from './chartRef';
export * from './commitStatus';
export * from './commitStatusCommitReference';
export * from './commitStatusDetails';
export * from './commitStatusItem';
...
export * from './environmentRoleBinding';
export * from './environmentRoleBindingList';
export * from './environmentRoleBindingSpec';
export * from './environmentRoleBindingStatus';
export * from './environmentSpec';
export * from './environmentStatus';
export * from './environmentVariable';
export * from './extension';
export * from './extensionConfig';
export * from './extensionConfigList';
export * from './extensionDefinition';
export * from './extensionDefinitionChildReference';
export * from './extensionDefinitionList';
export * from './extensionDefinitionReference';
export * from './extensionDefinitionReferenceList';
export * from './extensionExecution';
export * from './extensionList';
export * from './extensionParameter';
export * from './extensionParameterValue';
...
import { EnvironmentRoleBindingList } from './environmentRoleBindingList';
...
import { ExtensionConfigList } from './extensionConfigList';
...
import { ExtensionDefinitionList } from './extensionDefinitionList';
import { ExtensionDefinitionReference } from './extensionDefinitionReference';
import { ExtensionDefinitionReferenceList } from './extensionDefinitionReferenceList';
...
let typeMap: {[index: string]: any} = {
    ...
    "CommitStatusCommitReference": CommitStatusCommitReference,
    "CommitStatusDetails": CommitStatusDetails,
    "CommitStatusItem": CommitStatusItem,
    ...
    "EnvironmentRoleBinding": EnvironmentRoleBinding,
    "EnvironmentRoleBindingList": EnvironmentRoleBindingList,
    "EnvironmentRoleBindingSpec": EnvironmentRoleBindingSpec,
    "EnvironmentRoleBindingStatus": EnvironmentRoleBindingStatus,
    ...
    "ExtensionDefinitionChildReference": ExtensionDefinitionChildReference,
    "ExtensionDefinitionList": ExtensionDefinitionList,
    "ExtensionDefinitionReference": ExtensionDefinitionReference,
    "ExtensionDefinitionReferenceList": ExtensionDefinitionReferenceList,
    "ExtensionExecution": ExtensionExecution,
    "ExtensionList": ExtensionList,
    "ExtensionParameter": ExtensionParameter,
    "ExtensionParameterValue": ExtensionParameterValue,
